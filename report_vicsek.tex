...
This internship is a continuation and an improvement of the NEMO project.
The goal is to study the interactions between squirmers and their collective behaviors.\\

\subsubsection{Eo parameter}
The first thing done during the internship was to study the effect of the $Eo$ parameter on the alignment of the squirmers.\\
One can see the simulations done and their resulting graphs in the \texttt{graphs/Eo_analysis} and \texttt{videos/Eo_analysis} directories.\\
One also can type:
\begin{verbatim}
...
and modify the \texttt{Code/run.py} file with the parameters one wants to test,
 ...
 a simulation is done and the resulting graphs are stored in the \texttt{graphs} or \texttt{videos} 
 directory depending on one's choice.\\

\subsubsection{N squirmers}
