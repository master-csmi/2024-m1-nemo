        ...
        \begin{column}{0.5\textwidth}
            \begin{itemize}
                ...
                \begin{itemize}
                    ...
                    \item In particullar, we fix the type $\beta$ and the velocity $B1$.
                \end{itemize}
            \end{itemize}
        \end{column}
        \begin{column}{0.5\textwidth}
...
\begin{itemize}
    ...
    \item a squirmers is too close from the boundary if $\lvert R-R_j\rvert < 2^{\frac{1}{6}}a$, we add $\nabla_{R_{i}}V_{i}$
\end{itemize}    
\end{frame}
...
\begin{frame}{Conclusion and perspective}
    \begin{center}
        \begin{itemize}
            ...
            \item Investigating the interactions within a school of squirmers : collective behavior and emergent group effects
        \end{itemize}
    \end{center}
\end{frame}
