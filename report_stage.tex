...
The simulations are done with two squirmers of radius $a=0.05$, velocity $v_0=1$, viscosity $\mu = 1$, $\beta$ varying from $\beta_1 = 0$,
 $\beta_2 = -7.5$ and $\beta_3 = 7.5$, orientation $\theta$ varying between the major orientations of the unit circle.\\
 ...
 $$
 E_{0_{1}} = \frac{3}{10}\frac{v_0}{a}, E_{0_{2}} = \frac{16}{10}\mu\pi a^2 \cite{Brumley} \, E_{0_{3}} = \frac{-3}{2}\frac{v_0}{a} \cite{Lauga},
