...
\begin{itemize}
   ...
   is used to run the simulation, it takes the argument \texttt{choice} that can be:
   \begin{itemize}
    \item 'plot' to plot the graph of the behaviors of the squirmers in the 'graphs' directory
    \item 'video' to create a video of the behaviors of the squirmers in the 'videos' directory
    \item 'Eo\_sim', not used anymore, to test every Eo parameter and plot or make a video
