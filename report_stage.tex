...
\newpage
 \begin{figure}[h]
    ...
    \begin{minipage}{0.49\textwidth}
        \includegraphics[width=1\textwidth]{graphs/simulations/sim_sq_sq/beta0/pi_2_.png}
        \caption{\footnotesize Simulation parameters: $a=0.05$, $v_0=1$, $\beta_0=0$\\
        position and orientation of squirmer1: $(x1,y1)=(-a,0)$, $\theta_1=\frac{\pi}{2}$\\
        position and orientation of squirmer2: $(x2,y2)=(\frac{2a}{1.9},0)$, $\theta_2=\frac{\pi}{2}$}
    \end{minipage}\hfill
    \begin{minipage}{0.49\textwidth}
        \includegraphics[width=1\textwidth]{graphs/simulations/sim_sq_sq/beta1_5/pi_2_.png}
        \caption{\footnotesize Simulation parameters: $a=0.05$, $v_0=1$, $\beta_1=1.5$\\
        position and orientation of squirmer1: $(x1,y1)=(-a,0)$, $\theta_1=\frac{\pi}{2}$\\
        position and orientation of squirmer2: $(x2,y2)=(\frac{2a}{1.9},0)$, $\theta_2=\frac{\pi}{2}$}
    \end{minipage}
 \end{figure}
